...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [RouterOutlet, RouterLink, RouterLinkActive, MatToolbar, MatAnchor, FormsModule, MatNavList, MatListItem, MatIcon, MatButton],
...
export class NavbarComponent implements OnInit {
  ...
  constructor(private authService: AuthService, router: Router){ //, iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
