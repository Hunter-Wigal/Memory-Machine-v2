...
export class DragDropAPI {
  /**@type {(...restArgs?: string[]) => void} Function that is called when an element is dropped*/ dropFunction: (
    ...restArgs: any[]
  ) => void;
   ...
   */
  constructor(
    dropFunction: (...restArgs: string[]) => void = function (
      ...restArgs: any[]
    ) {},
  ...
  canvasdrag() {
    ...
    function canDrop(clientRect: DOMRect) {
      ...
      if (!height || !topLeft || !width) return;
